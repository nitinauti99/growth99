...
extension CIQRCodeDescriptor.ErrorCorrectionLevel: FargoDumpStringConvertible {
...
extension CIDataMatrixCodeDescriptor.ECCVersion: FargoDumpStringConvertible {
    public var fargoDumpDescription: String {
        switch self {
        case .v000:
...
extension CIRenderDestinationAlphaMode: FargoDumpStringConvertible {
    public var fargoDumpDescription: String {
        switch self {
        case .none:
