...
#if !os(watchOS)
extension UIGestureRecognizer.State: FargoDumpStringConvertible {
...
extension UIScrollView.ContentInsetAdjustmentBehavior: FargoDumpStringConvertible {
    public var fargoDumpDescription: String {
        switch self {
        case .always:
...
extension UIUserInterfaceStyle: FargoDumpStringConvertible {
    public var fargoDumpDescription: String {
        switch self {
        case .dark:
...
extension UIControl.State: FargoDumpReflectable {
