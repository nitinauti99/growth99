//
//  LeadCreationCombineTimeLineTableViewCell.swift
//  Growth99
//
...
class LeadCreationCombineTimeLineTableViewCell: UITableViewHeaderFooterView {
    ...
    func configureCell(timeLineVM: CombineTimeLineViewModelProtocol?, index: Int) {
