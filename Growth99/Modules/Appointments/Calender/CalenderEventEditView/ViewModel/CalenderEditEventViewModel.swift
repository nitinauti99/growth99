//
//  CalenderEditEventViewModel.swift
//  Growth99
//
...
protocol CalenderEditEventViewModelProtocol {
...
class CalenderEditEventViewModel: CalenderEditEventViewModelProtocol {
    
    var delegate: CalenderEditEventViewControllerProtocol?
    var allDates: [String] = []
    var allTimes: [String] = []
    ...
    init(delegate: CalenderEditEventViewControllerProtocol? = nil) {
