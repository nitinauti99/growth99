...
struct MassEmailSMSPTagListModel: Codable, Equatable {
    let name: String?
    let isDefault: Bool?
    let id: Int?
...
struct MassEmailSMSLeadAllCountModel : Codable {
    let smsCount : Int?
    let emailCount : Int?
}

struct MassEmailSMSPatientsAllCountModel : Codable {
    let smsCount : Int?
    let emailCount : Int?
}
...
struct MarketingLeadModel : Codable {
    ...
    let patientTags : [MassEmailSMSPTagListModel]?
    let patientStatus : [String]?
