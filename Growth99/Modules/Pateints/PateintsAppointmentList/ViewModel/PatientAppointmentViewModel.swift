...
class PatientAppointmentViewModel: PatientAppointmentViewModelProtocol {
    ...
    func getPatientAppointmentList(pateintId: Int) {
        ...
        self.requestManager.request(forPath: finaleUrl, method: .GET, headers: self.requestManager.Headers()) { (result: Result<CalenderInfoListModel, GrowthNetworkError>) in
            switch result {
