...
class LeadTriggersTableViewCell: UITableViewCell {
    ...
    func configureCell(triggerFilterList: TriggersListModel?, index: IndexPath, isSearch: Bool) {
        ...
        self.createdDate.text =  dateFormater?.serverToLocalDateConverter(date: triggerFilterList?.createdAt ?? String.blank)
        self.createdBy.text = triggerFilterList?.createdBy
        self.updatedDate.text =  dateFormater?.serverToLocalDateConverter(date: triggerFilterList?.updatedAt ?? String.blank)
    ...
    func configureCell(triggerList: TriggersListModel?, index: IndexPath, isSearch: Bool) {
        ...
        self.createdDate.text =  dateFormater?.serverToLocalDateConverter(date: triggerList?.createdAt ?? String.blank)
        self.createdBy.text = triggerList?.createdBy
        self.updatedDate.text =  dateFormater?.serverToLocalDateConverter(date: triggerList?.updatedAt ?? String.blank)
