//
//  CreateDefaultQuestionnaireTableViewCell.swift
//  Growth99
//
//  Created by Nitin Auti on 12/06/23.
//

import UIKit

protocol CreateDefaultQuestionnaireTableViewCellDelegate: AnyObject {
        func saveFoemData(data: [String : Any])
        func popToView()
}

class CreateDefaultQuestionnaireTableViewCell: UITableViewCell{
    ...
    @IBOutlet weak var Show_Custom_Content_Virtual_ConsultationLead_Form: CustomTextView!
    ...
    @IBOutlet weak var Show_Thank_page_URL_Virtual_Consultation: UIButton!
    @IBOutlet weak var Show_Thank_page_URL_Virtual_Consultation_TextField: CustomTextField!
    @IBOutlet weak var Show_Thank_page_URL_Virtual_Consultation_TextField_Hight: NSLayoutConstraint!
    
    @IBOutlet weak var Show_Thank_page_URL_Landing_Page: UIButton!
    @IBOutlet weak var Show_Thank_page_URL_Landing_Page_TextField: CustomTextField!
    @IBOutlet weak var Show_Thank_page_URL_Landing_Page_TextField_Hight: NSLayoutConstraint!
    ...
    public func setUPVale() {
        ...
        Show_Custom_Content_Virtual_ConsultationLead_Form.text = item?.textForComposer
        ...
        self.Show_Thank_page_URL_Virtual_Consultation.isSelected = item?.showThankYouPageUrlLinkInVC ?? false
        
        if item?.showThankYouPageUrlLinkInVC  == true {
            Show_Thank_page_URL_Virtual_Consultation_TextField_Hight.constant = 45
            Show_Thank_page_URL_Virtual_Consultation_TextField.isHidden = false
        ...
        if item?.showThankYouPageUrlLinkInLandingPage  == true {
            ...
            Show_Thank_page_URL_Landing_Page_TextField.isHidden = false
            Show_Thank_page_URL_Landing_Page_TextField.text = item?.thankYouPageUrlLandingPage ?? String.blank
        }
    ...
    @IBAction func Show_Thank_page_URL_Virtual_Consultation_Action(sender: UIButton) {
        print("Show_Thank_page_URL_Virtual_Consultation")
        if sender.isSelected {
            sender.isSelected = false
            Show_Thank_page_URL_Virtual_Consultation_TextField.isHidden = true
            Show_Thank_page_URL_Virtual_Consultation_TextField_Hight.constant = 0
        } else {
            sender.isSelected = true
            Show_Thank_page_URL_Virtual_Consultation_TextField.isHidden = false
            Show_Thank_page_URL_Virtual_Consultation_TextField_Hight.constant = 45
    ...
    @IBAction func Show_Thank_page_URL_Landing_Page_Action(sender: UIButton) {
        print("Show_Thank_page_URL_Virtual_Consultation")
        if sender.isSelected {
            sender.isSelected = false
            Show_Thank_page_URL_Landing_Page_TextField.isHidden = true
            Show_Thank_page_URL_Landing_Page_TextField_Hight.constant = 0
        } else {
            sender.isSelected = true
            Show_Thank_page_URL_Landing_Page_TextField.isHidden = false
            Show_Thank_page_URL_Landing_Page_TextField_Hight.constant = 45
...
extension CreateDefaultQuestionnaireTableViewCell {
        ...
        @IBAction func saveAction(sender: UIButton){
            ...
            let createFormList: [String : Any] = [
                ...
                "textForComposer": Show_Custom_Content_Virtual_ConsultationLead_Form.text ?? String.blank,
                "showThankYouPageUrlLinkInVC": self.Show_Thank_page_URL_Virtual_Consultation.isSelected,
                "thankYouPageUrlVC": Show_Thank_page_URL_Virtual_Consultation_TextField.text ?? String.blank,
                "showThankYouPageUrlLinkInLandingPage": self.Show_Thank_page_URL_Landing_Page.isSelected,
                "thankYouPageUrlLandingPage": Show_Thank_page_URL_Landing_Page_TextField.text ?? String.blank,
